...
(0, _cucumber.Then)(/^I select the "([^"]*)" option from the "([^"]*)"$/, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(option, elementKey) {
    var page, globalConfig, elementIdentifier;
...
(0, _cucumber.Then)(/^I fill in the "([^"]*)" input with random "([^"]*)"$/, /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(elementKey, randomInputType) {
    var page, globalConfig, elementIdentifier, validRandomInputType;
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 2:
                  ...
                  _context5.next = 7;
                  return (0, _htmlBehavior.inputElementValue)(page, elementIdentifier, randomContent);
                case 7:
