...
public class DaciaHomePage {
    ...
    public static String locAcceptCookies = "#onetrust-accept-btn-handler";
    public static String locFormAskForOffers = "//form[@class='Form-module_form__jNBDR RequestOffer_form-wrapper__ySa2C']";
    public static String locFormName = "//input[@id='name']";
