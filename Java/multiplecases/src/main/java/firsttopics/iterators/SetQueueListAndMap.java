package main.java.firsttopics.iterators;
...
public class SetQueueListAndMap {
    ...
    private static void mapDemo() {
        ...
        fruit.put("banana", 30);
        fruit.put("cherry", 20);
        fruit.put("cherry", 3);         // No duplicated key is allowed in HashMaps
        fruit.put("lemon", 15);
    ...
    private static void setDemo() {
        ...
        fruit.add("banana");
        fruit.add("apple");
        fruit.add("lemon");             // HashSet elements must not be duplicated
